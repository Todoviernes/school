...
from school.school_system.forms import (StudentForm, FacultyForm, StaffForm, AbsenceForm, TardyForm,
                                        ExcuseForm, AssignmentForm, GradeForm, ForumForm, ForumPostForm)
